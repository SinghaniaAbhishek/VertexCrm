      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden opacity-0 animate-[fadeIn_0.5s_ease-out_0.2s_forwards]">
          <div className="grid lg:grid-cols-2">
            {/* Left Side - Benefits */}
            <div className="bg-gradient-to-br from-slate-900 via-indigo-900 to-slate-900 p-10 lg:p-12 flex flex-col justify-center order-2 lg:order-1">
              <div className="mb-6">
                <h3 className="text-2xl font-bold text-white mb-3">
                  Trusted by industry leaders
                </h3>
                <p className="text-gray-300">
                  Join 10,000+ businesses accelerating growth.
                </p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-5 border border-white/20 mb-4">
                ...
                <p className="text-gray-200 text-sm italic mb-2">
                  "Sales team productivity increased by 40% in 3 months!"
                </p>
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 border border-white/20 text-center">
                  ...
                  <p className="text-xs text-gray-300 mt-1">Satisfaction</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 border border-white/20 text-center">
                  <p className="text-xl font-bold text-white">2.5x</p>
                  <p className="text-xs text-gray-300 mt-1">ROI Growth</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 border border-white/20 text-center">
